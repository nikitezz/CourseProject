...
// canv for the moving PolyPiece and the full image
  ...
  if (!this.menu) {
    this.menu = new Menu({
      ...
      lineStep: 30,
      lines: [
        {text: "Выбрать ", func: this.loadImage()},
        {text: "12 пазлов", func: this.returnFunct(12)},
        {text: "25 пазлов", func: this.returnFunct(25)},
        {text: "50 пазлов", func: this.returnFunct(50)},
        {text: "100 пазлов", func: this.returnFunct(100)},
        {text: "200 пазлов", func: this.returnFunct(200)}
      ]
    });
  }
  if (autoStart) {
...
let img = 'https://planetabelarus.by/temp_upload/medialibrary/d46/d4689a7dcae2d81b86856588c620b23c.jpg';
